...
- **インストーラー版**: `MultiImageCanvas-1.0.5-Setup.exe`
...
- **ポータブルZIP版**: `MultiImageCanvas-1.0.5-portable-win-x64.zip`
...
- **タブ管理**: 複数のキャンバスをタブで管理します（新規作成、右クリックで名前変更、並び替え、ホイールスクロール）。キャンバスごとの直接切り替えキーも設定できます。
